    ...
    Accomodation.updateOne({
        ...
        if (err) {
            ...
            let mailOptions = {
                ...
                subject: "GyanMitra20 - Accomodation Payment",
                html: "<ol><li>The Demand draft must be drawn in favour of Mepco Schlenk Engineering College</li><li>The Demand draft must be payable at Sivakasi, Tamil Nadu</li><li>At the back side of your DD<b></b>, write your <b>GM ID</b> followed by 'Accomodation' and the number of days with pencil</li><li>Demand draft must reach us on or before <b>Date-Jan-2020</b> via any means to the address : <br />The Convenor,<br />GyanMitra 20,<br />Mepco Schlenk Engineering College,<br />Virudhunagar District,<br />Tamil Nadu - 626 006<br /></li></ol>"
            }
...
router.post('/create', (req, res, next) => {
    ...
    newAccommodation.save((err, doc) => {
        if (err) {
            ...
            res.json({
                error: false,
                msg: 'Accommodation request Successful'
            });
        }
    });
});
...
// Deprove Accommodation by Admin
// Created By : Aravind S
// Date : 02-January-2019
...
// Reject Accommodation Payment by Admin
// Created By : Aravind S
// Date : 02-January-2019
...
//Reviewed and Edited By Narayanan SL on 16/12/19